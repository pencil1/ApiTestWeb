            ...
            <table style="padding:10px;font-size: 14px;line-height: 25px;width: 100%;position:relative;"
              ...
              <tr v-show="statusShow[4]">
                ...
                <td class="content">
                  ...
                  <pre
                      style="white-space: pre-wrap;word-wrap: break-word;">{{ this.meta_datas.data[0].request.json }}</pre>
                </td>
              </tr>
              ...
              <tr v-show="statusShow[8]">
                ...
                <td class="content">
                  <pre
                      style="white-space: pre-wrap;word-wrap: break-word;">{{ this.meta_datas.data[0].response.json }}</pre>
